...
-- ============================================================
-- 1. DEMO — Demographics (one row per deduplicated case)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS faers_drug (
    ...
    primaryid           BIGINT      NOT NULL REFERENCES faers_demo(primaryid) ON DELETE CASCADE,
    caseid              BIGINT      NOT NULL,
    drug_seq            INT,
...
CREATE INDEX IF NOT EXISTS idx_drug_primaryid_role
    ON faers_drug(primaryid, role_cod);
...
CREATE INDEX IF NOT EXISTS idx_ther_primaryid
    ON faers_ther(primaryid);
CREATE INDEX IF NOT EXISTS idx_ther_primaryid_seq
    ON faers_ther(primaryid, drug_seq);
